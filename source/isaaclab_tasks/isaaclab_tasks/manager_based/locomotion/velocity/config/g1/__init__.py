...
gym.register(
    id="Isaac-Velocity-Flat-G1-Waiter-Basic-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.waiter_env_basic_cfg:G1WaiterEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1WaiterBasicPPORunnerCfg",
    },
)


gym.register(
    id="Isaac-Velocity-Flat-G1-Waiter-Basic-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.waiter_env_basic_cfg:G1WaiterEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1WaiterBasicPPORunnerCfg",
    },
)
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.low_height_env_cfg:G1LowHeightEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1LowHeightPPORunnerCfg",
    },
)


gym.register(
    id="Isaac-Velocity-Flat-G1-LowHeight-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.low_height_env_cfg:G1LowHeightEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1LowHeightPPORunnerCfg",
    },
)
